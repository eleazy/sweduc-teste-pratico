...
class POP3
{
     ...
     * @return boolean
     */
    public function authorise($host, int|bool $port = false, int|bool $timeout = false, $username = '', $password = '', $debug_level = 0)
    {
        $this->host = $host;
     ...
     * @return boolean
     */
    public function connect($host, int|bool $port = false, $tval = 30)
    {
