...
/**
 * Interpretador de retorno de remessa
 * Layout da Caixa Economica Federal (CEF)
 * Versão do layout: 47
 *
 * Referência http://www.caixa.gov.br/Downloads/cobranca-caixa/Manual_de_Leiaute_de_Arquivo_Eletronico_CNAB_240.pdf
 *
 */
...
if ($numerobanco != "104") {
    ...
    $convenio = substr($header_arq, 58, 7);
