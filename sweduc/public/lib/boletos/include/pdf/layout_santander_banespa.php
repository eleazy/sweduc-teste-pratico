        ...
        <table cellspacing=0 cellpadding=0 style="width:150px">
          <tbody>
            <tr><td valign=top style="border-bottom:1px solid #000;">
              <IMG src="./lib/boletos/imagens/logosantander.jpg" width="140" height="37" style="float:left;">
            </td></tr>
            ...
            <tr><td valign=top style="border-bottom:1px solid #000;height:15px;">
              ...
              <span class=ct1><?php
                $tmp2 = $dadosboleto["codigo_cliente"]; $tmp2 = substr($tmp2,0,strlen($tmp2)-1).'-'.substr($tmp2,strlen($tmp2)-1,1);
            ...
            <tr><td valign=top style="border-bottom:1px solid #000;height:15px;">
              ...
              <!--  <span class=ct1><?/* $tmp = str_pad($dadosboleto["numero_documento"], 9, "0", STR_PAD_LEFT); print $tmp; */?></span>-->
            </td></tr>
            ...
            <table cellspacing=0 cellpadding=0>
              <tbody>
                ...
                <tr>
                  <td class=cp valign=top width=7 height=12>
                    <img height=12 src=./lib/boletos/imagens/1.png width=1></td>
                  <td class=cp valign=top width=180 height=12></td>
                </tr>
                <tr>
                  <td valign=top width=7 height=1>
                    <img height=1 src=./lib/boletos/imagens/2.png width=7></td>
    ...
    <TABLE cellSpacing=0 cellPadding=0 width=666>
      <TBODY>
        <TR>
          ...
          <TD class=ct  width=409 >Pagadorr/Avalista</TD>
