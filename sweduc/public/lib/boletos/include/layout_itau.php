    ...
    <style type=text/css>
        ...
        *{margin: 0;}
        body{
            top:0px;
            left:0px;
            margin: 25px 0px 0px 70px; /* margem reduzida para aproveitamento de espaço */
  ...
  <BODY text=#000000 bgColor=#ffffff>
    ...
    <table cellspacing=0 cellpadding=3 style="width:500px" border=0>
      <tr><td style="border-right:1px dashed #000;vertical-align:top;">
        ...
        <table class="test" cellspacing=0 cellpadding=0 border=0 style="width:150px">
          <tbody>

            <tr><td valign=top style="border-bottom:1px solid #000;">
              <IMG src="imagens/logoitau.jpg" width="150" height="40" border=0 style="float:left;">
            </td></tr>
