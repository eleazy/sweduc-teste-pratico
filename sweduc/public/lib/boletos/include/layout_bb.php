    ...
    <head>
        ...
        <style type=text/css>
            ...
            *{margin: 0;}
            ...
            top:0px;
            left:0px;
                margin: 10px 0px 0px 50px; /* margem reduzida para aproveitamento de espaço */
                        ...
                        <tbody>
                            <tr>
                                <td valign=top style="border-bottom:1px solid #000;">
                                    <IMG src="imagens/logobb.jpg" width="150" height="40" border=0 style="float:left;">
                                </td>
                            </tr>
                    ...
                    <table cellspacing=0 cellpadding=0 width=666 border=0>
                        <tr>
                            <td class=cp width=150>
                                <span class="campo">
                                    <IMG src="imagens/logobb.jpg" width="150" height="40" border=0>
                                </span>
                            </td>
                    ...
                    <table cellspacing=0 cellpadding=0 border=0>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class=cp valign=top width=472 height=12>Até o vencimento, preferencialmente no Banco do Brasil. Após o vencimento, somente no Banco do Brasil </td>
                                <td class=cp valign=top width=7 height=12>
                                    <img height=12 src=imagens/1.png width=1 border=0>
                                </td>
