...
if (!function_exists('fator_vencimento_hsbc')) {
    function fator_vencimento_hsbc($data)
    {
...
if (!function_exists('monta_linha_digitavel_hsbc')) {
    function monta_linha_digitavel_hsbc($codigo)
    {
        // Posi��o    Conte�do
...
$nummoeda = "9";
$fator_vencimento = fator_vencimento_hsbc($dadosboleto["data_vencimento"]);
...
$dadosboleto["linha_digitavel"] = monta_linha_digitavel_hsbc($linha);
