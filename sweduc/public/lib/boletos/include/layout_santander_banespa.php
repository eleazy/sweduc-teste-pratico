      ...
      <tbody>
        ...
        <tr>
          ...
          <td class=cp valign=top width=659 height=12>
            ...
            <span class="campo" style="float:right; margin-right:100px;"><?php echo "Aluno: " . substr($dadosboleto["nomealuno"], 0, 30)?></span>
          </td>
        </tr>
      </tbody>
    </table>
      ...
      <tbody>
        <tr>
          ...
          <td class=cp valign=top width=659 height=12>
            ...
            <span class="campo" style="float:right; margin-right:100px;"><?php echo substr($dadosboleto["cursoturma"], 0, 30)?></span>
          </td>
        </tr>
      </tbody>
    </table>
