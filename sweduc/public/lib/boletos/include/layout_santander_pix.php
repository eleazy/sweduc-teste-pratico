...
$emvqrcode = PixController::extractQrCodeEMV($dadosboleto["pixUrl"] ?? '');
        ...
        <table cellspacing=0 cellpadding=0 border=0 style="width:150px">
          <tbody>
            ...
            <tr><td valign=top style="border-bottom:1px solid #000;">
              <IMG src="imagens/logosantandernovo.png" width="150" height="37" border=0 style="float:left;">
            </td></tr>
            ...
            <tr><td valign=top style="border-bottom:1px solid #000;height:15px;">
              <span class=cp1>Nosso Número</span>
                ...
                print $tmp; ?></span>
              <!--  <span class=ct1><?php /* $tmp = str_pad($dadosboleto["numero_documento"], 9, "0", STR_PAD_LEFT); print $tmp; */?></span>-->
            </td></tr>
            ...
            <tr><td valign=top style="border-bottom:0px solid #000;height:15px;">
              ...
              <span class=ct1><?php echo "N. Documento: " . $dadosboleto["numero_documento"] . "<br />" . $dadosboleto["sacado"] . "<br />" . $dadosboleto["cpf"]; ?></span>
            </td></tr>
    ...
    <table cellspacing=0 cellpadding=0 border=0>
      <tbody>
        <tr>
          ...
          <td class=ct valign=top width=7 height=13>
            <img height=13 src=imagens/1.png width=1 border=0></td>
          <td class=ct valign=top width=180 height=13>Agência/Beneficiário</td>
        </tr>
        <tr>
          <td class=cp valign=top width=7 height=12>
            <img height=12 src=imagens/1.png width=1 border=0></td>
          <td class=cp valign=top width=472 height=12>
            <span class="campo">
              <?php echo $dadosboleto["cedente"] . ' - ' . $dadosboleto["cpf_cnpj"]?>
            </span></td>
          <td class=cp valign=top width=7 height=12>
            <img height=12 src=imagens/1.png width=1 border=0></td>
          <td class=cp valign=top align=right width=180 height=12>
      ...
      <tbody>
        <tr>
          <td align=right width=10>
            <table cellspacing=0 cellpadding=0 border=0 align=left>
              <tbody>
                ...
                <td align=right width=10>
                    <?php if (!empty($dadosboleto["pixUrl"])) : ?>
                        <IMG src="imagens/logopix.png" width="80" height="30" border=0 style="position: absolute;top: 200px; right: 425px;">
                    <?php endif ?>
                </td>
                <td align=right width=10>
                    <?php if (!empty($dadosboleto["pixUrl"])) : ?>
                        <img src="data:image/png;base64,<?php echo fqrcode($emvqrcode); ?>" alt="QR Code" width="110" height="110" border="0" style="position: absolute;top: 164px; right: 308px;">
                    <?php endif ?>
                </td>
              </tbody>
            </table></td>
          <td valign=top width=468 rowspan=5>
            ...
            <br>
            <span class=cp>
              <FONT class=campo style="display:block; width:260px; word-wrap:break-word;">
              ...
              <br>
                <?php if (!empty($dadosboleto["pixUrl"])) : ?>
                    <font class="ct" style="font-size: 10px; font-weight: bold; margin-top: 0; position: relative; bottom: 0px;">Pix Copia e Cola
                    </font>
                <?php endif ?>
                <br>
                <?php if (!empty($dadosboleto["pixUrl"])) : ?>
                    <font class="ct" style="display:block; width:260px; font-size: 6px; word-break: break-all; margin-top: 0;"><?= $emvqrcode ?>
                    </font>
                <?php endif ?>
                  <br>
                  <br>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class=cp valign=top width=659 height=12>
            ...
            <span class="campo" style="float:right; margin-right:200px;"><?php echo "Aluno: " . substr($dadosboleto["nomealuno"], 0, 30)?></span>
          </td>
        </tr>
      </tbody>
    </table>
      ...
      <tbody>
        <tr>
          ...
          <td class=cp valign=top width=659 height=12>
            ...
            <span class="campo" style="float:right; margin-right:200px;"><?php echo substr($dadosboleto["cursoturma"], 0, 30)?></span>
          </td>
        </tr>
      </tbody>
    </table>
