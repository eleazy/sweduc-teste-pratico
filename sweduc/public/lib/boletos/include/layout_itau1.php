...
<HTML>
  ...
  <BODY text=#000000 bgColor=#ffffff style="margin:0px;">


    <table cellspacing=0 cellpadding=3 style="width:500px" border=0>
      <tr><td style="border:0px solid #000;vertical-align:top;">

          <div style="margin-left:0px;margin-right:10px;">
            <IMG src="imagens/logoitau.jpg" width="150" height="40" border=0 style="float:left;"><br />
            <b class=cp style="float:right;">Recibo do Sacado</b>
          </div>

          <table cellspacing=2 cellpadding=2 border=1 style="width:300px">
            <tbody>
              <tr><td colspan="2" valign=top width=298 height=40 class=ct>
                <span class=cp>Cedente<br /></span>
                <span class=ct><?php echo $dadosboleto["cedente"]; ?></span>
              </td></tr>
              <tr><td><span class=cp>Agência/Código do Cedente<br /></span><span class=ct>
                <?php echo $dadosboleto["agencia"]." / ".$dadosboleto["conta"]."-".$dadosboleto["conta_dv"];?>
                </span>
              </td>
              <td><span class=cp>Data Documento<br /></span><span class=ct><?php echo $dadosboleto["data_documento"]?></span></td></tr>
              <tr><td><span class=cp>
                Nosso Número<br /><?php $tmp = $dadosboleto["nosso_numero"]; $tmp = substr($tmp,0,strlen($tmp)-1).'-'.substr($tmp,strlen($tmp)-1,1); print $tmp; ?>
              </td><td><span class=cp>Nº Documento<br /></span><span class=ct><?php echo $dadosboleto["numero_documento"]?></span></td></tr>
              <tr><td colspan="2" valign=top width=298 height=40 class=ct><span class=cp>Sacado<br /></span><span class=ct>
                <?php echo $dadosboleto["sacado"]; ?><br />
                <?php echo $dadosboleto["endereco1"]?><br />
                <?php echo $dadosboleto["endereco2"]?><br />
              </span></td></tr>
              <tr><td><span class=cp>Vencimento<br /></span><span class=ct>
                <?php echo $dadosboleto["data_vencimento"]; ?></span></td>
                <td><span class=cp>Valor Documento<br /></span><span class=ct><?php echo $dadosboleto["valor_boleto"]?></span></td></tr>
             </tbody>
          </table>
          <table cellspacing=5 cellpadding=10 border=0 width="100%">
            <tr><td class=ct style="border:1px solid #000; border-bottom:0px; height:50px; vertical-align:text-top;">Autenticação mecânica<br /></td></tr>
          </table>
