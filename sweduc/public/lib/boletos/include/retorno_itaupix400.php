...
if ($numerobanco != "341") { ?>
    ...
    $ccsemdigito = substr($header_arq, 32, 5);
                ...
                <table border="1" width="100%" cellpadding="0" cellspacing="0"  class="table table-striped">
                    ...
                    for ($i = 1; $i < $cnt; $i++) {
                        ...
                        if ($detalhe_arq[0] == 3) {
                            ...
                            $emvqrcode = trim(substr($detalhe_arq, 1, -11));
                            $queryQr = "INSERT INTO pix (financeiro_retornos_id,alunos_fichafinanceira_id,emvqrcode) VALUES ($idfinanceiro_retornos,$idfichafinanceira,'$emvqrcode')";
                        ...
                        if ($detalhe_arq[0] != 3) {
                            ...
                            <tr>
                                ...
                                if ($retorno_data_baixa == 1 && $detalhe_arq[296] != " ") { // data de crédito, se não for vazio
                                ...
                                <td>
                                    <?php
                                    $queryTMP = "SELECT alunos_fichafinanceira.id as idffin, idcontasbanco as idcbanco FROM alunos_fichafinanceira WHERE situacao=0 AND titulo='$nossonumero' AND idcontasbanco IN ($idcontasbanco)";
                                    $resultTMP = mysql_query($queryTMP);
                                    $rowTMP = mysql_fetch_array($resultTMP, MYSQL_ASSOC);
                                    $idfichafinanceira = $rowTMP['idffin'];
