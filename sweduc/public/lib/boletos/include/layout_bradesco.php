...
$r = explode('/', $dadosboleto["agencia_codigo"]);
$dadosboleto["agencia_codigo"] = trim($r[0])  . modulo_10(trim($r[0])) . '/' . $r[1];
?>
    ...
    <style type=text/css>
        ...
        *{margin: 0;}
        body{
            top:0px;
            left:0px;
            margin: 20px 0px 0px 70px; /* margem reduzida para aproveitamento de espaço */
...
<body text=#000000 bgColor=#ffffff>
    <table cellspacing=0 cellpadding=3 style="width:500px" border=0>
        <tr>
            <td style="border-right:1px dashed #000;vertical-align:top;">
            <table cellspacing=0 cellpadding=0 border=0 style="width:150px">
                <tbody>
                <tr>
                    <td valign=top style="border-bottom:1px solid #000;">
                    <IMG src="imagens/logobradesco.jpg" width="140" height="37" border=0 style="float:left;">            </td>
                </tr>
                <tr>
                    <td valign=top style="border-bottom:1px solid #000;height:15px;">
                    <span class=cp1>Vencimento
                    </span>
                    <span class=ct1>
                ...
                <tr>
                    <td valign=top style="border-bottom:1px solid #000;height:15px;">
                    <span class=cp1>Agência / Código
                    </span>
                    <span class=ct1><?php echo $dadosboleto["agencia_codigo"]?>
                    </span>            </td>
                </tr>
                <tr>
                    <td valign=top style="border-bottom:1px solid #000;height:15px;">
                    <span class=cp1>Nosso Número
                    </span>
                    <span class=ct1>
                ...
                <tr>
                    <td valign=top style="border-bottom:1px solid #000;height:15px;">
                    <span class=cp1>(=)Valor Documento
                    </span>
                    <span class=ct1>
                ...
                <tr>
                    <td valign=top style="border-bottom:1px solid #000;height:15px;">
                    <span class=cp1>(-)Desconto / Abatimentos
                    </span>
                    <span class=ct1>&nbsp;
                    </span>            </td>
                </tr>
                <tr>
                    <td valign=top style="border-bottom:1px solid #000;height:15px;">
                    <span class=cp1>(-)Outras Deduções
                    </span>
                    <span class=ct1>&nbsp;
                    </span>            </td>
                </tr>
                ...
                <tr>
                    <td valign=top style="border-bottom:1px solid #000;height:15px;">
                    <span class=cp1>(+)Outros Acréscimos
                    </span>
                    <span class=ct1>&nbsp;
                    </span>            </td>
                </tr>
                <tr>
                    <td valign=top style="border-bottom:1px solid #000;height:15px;">
                    <span class=cp1>(=)Valor Cobrado
                    </span>
                    <span class=ct1>&nbsp;
                    </span>            </td>
                </tr>
                <tr>
                    <td valign=top style="border-bottom:0px solid #000;height:15px;">
                    <span class=cp1>Pagador
                    </span>
                    <span class=ct1>
                        <?php echo "N. Documento: " . $dadosboleto["numero_documento"] . "<br />" . $dadosboleto["sacado"] . "<br />" . $dadosboleto["cpf"]; ?>
                    </span>            </td>
                </tr>
                </tbody>
            </table>
            ...
            <table cellspacing=0 cellpadding=0 border=0>
                ...
                <tr>
                    <td class=ct valign=top width=7 height=13>
                    <img height=13 src=imagens/1.png width=1 border=0></td>
                    <td class=ct valign=top width=472 height=13>Beneficiário CPF/CNPJ </td>
                    <td class=ct valign=top width=7 height=13>
                    <img height=13 src=imagens/1.png width=1 border=0></td>
            ...
            <table cellspacing=0 cellpadding=0 width=666 border=0>
                ...
                <tr>
                    ...
                    <td valign=top width=468 rowspan=5>
                        <font class=ct>Instruções  (Texto de responsabilidade do Beneficiário)</font>
                        <br>
                        <br>
                        <span class=cp>
                            <FONT class=campo>
