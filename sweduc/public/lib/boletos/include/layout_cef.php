...
<HTML>
    <HEAD>
        ...
        <style type=text/css>
            ...
            :root {
            --scale-value: 1.07; /* Escala reduzida para aproveitamento de espaço */
            }
            ...
            *{margin: 0;}
            body{
                top:0px;
                left:0px;
                margin: 15px 0px 0px 90px; /* margem reduzida para aproveitamento de espaço */
    ...
    <BODY text=#000000 bgColor=#ffffff>
        <table cellspacing=0 cellpadding=3 style="width:1100px; margin-left:-34px" border=0>
            <tr>
                <td style="border-right:1px dashed #000;vertical-align:top;width:200px">
                    <table cellspacing=0 cellpadding=0 border=0 style="width:200px">
                        <tbody>
                            <tr>
                                <td valign=top style="border-bottom:1px solid #000;height:22px;">
                                    <IMG src="imagens/logocaixa.jpg" width="120" height="30" border=0 style="float:left;">
                                </td></tr>
                            ...
                            <tr><td valign=top style="border-bottom:0px solid #000;height:35px;">
                                    <span class=cp1>RECIBO DO PAGADOR</span><br />
                ...
                <td>
                    <table cellspacing=0 cellpadding=0 width=680 border=0>
                        <tr>
                            <td class=cp width=150>
                                <span class="campo">
                                    <IMG        src="imagens/logocaixa.jpg" width="120" height="30"        border=0>
                                </span></td>
                            ...
                            <td class=ld align=right width=467 valign=bottom>
                                <span class=ld>
                                    <span class="campotitulo" style="font-size: 16.7px;
                                          width: 470px;
                                          display: block;">
                        ...
                        <tbody>
                            <tr>
                                <td colspan=5>
                                    <img height=2 src=imagens/2.png width=680 border=0></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table cellspacing=0 cellpadding=0 border=0>
                        <tbody>
                            <tr>
                                ...
                                <td class=ct valign=top width=486 height=13>Local de pagamento</td>
                                <td class=ct valign=top width=7 height=13>
                                    <img height=13 src=imagens/1.png width=1 border=0></td>
                            ...
                            <tr>
                                ...
                                <td class=cp valign=top width=486 height=12>PREFERENCIALMENTE NAS CASAS LOTÉRICAS ATÉ O VALOR LIMITE</td>
                                <td class=cp valign=top width=7 height=12>
                                    <img height=12 src=imagens/1.png width=1 border=0></td>
                            ...
                            <tr>
                                ...
                                <td valign=top width=486 height=1>
                                    <img height=1 src=imagens/2.png width=486 border=0></td>
                                <td valign=top width=7 height=1>
                                    <img height=1 src=imagens/2.png width=7 border=0></td>
                    ...
                    <table cellspacing=0 cellpadding=0 border=0>
                        <tbody>
                            <tr>
                                ...
                                <td class=ct valign=top width=299 height=13>Beneficiário</td>
                                <td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td>
                                <td class=ct valign=top width=180 height=13>CPF / CNPJ do Beneficiário</td>
                                <td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td>
                            ...
                            <tr>
                                ...
                                <td class=cp valign=top width=299 height=12>
                                    <span class="campo">
                                        <?php echo $dadosboleto["cedente"] ?>
                                    </span></td>
                                <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
                                <td class=cp valign=top width=180 height=12>
                                    <span class="campo">
                            ...
                            <tr>
                                ...
                                <td valign=top width=299 height=1><img height=1 src=imagens/2.png width=299 border=0></td>
                                <td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td>
                    ...
                    <table cellspacing=0 cellpadding=0 border=0>
                        <tbody>
                            <tr>
                                <td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td>
                                <td class=ct valign=top width=638 height=13>Endereço do Beneficiário</td>
                            </tr>
                            <tr>
                                <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td>
                                <td class=cp valign=top width=638 height=12>
                                    <span class="campo">
                            ...
                            <tr>
                                <td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td>
                                <td valign=top width=675 height=1><img height=1 src=imagens/2.png width=675 border=0></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table cellspacing=0 cellpadding=0 border=0>
                        <tbody>
                            <tr>
                                ...
                                <td class=ct valign=top width=7 height=13>
                                    <img height=13 src=imagens/1.png width=1 border=0></td>
                                <td class=ct valign=top width=147 height=13>Nr do documento</td>
                                <td class=ct valign=top width=7 height=13>
                                    <img height=13 src=imagens/1.png width=1 border=0></td>
                            ...
                            <tr>
                                ...
                                <td class=cp valign=top width=7 height=12>
                                    <img height=12 src=imagens/1.png width=1 border=0></td>
                                <td class=cp valign=top width=147 height=12>
                                    <span class="campo">
                            ...
                            <tr>
                                ...
                                <td valign=top width=133 height=1>
                                    <img height=1 src=imagens/2.png width=147 border=0></td>
                                <td valign=top width=7 height=1>
                                    <img height=1 src=imagens/2.png width=7 border=0></td>
                                ...
                                <td valign=top width=102 height=1>
                                    <img height=1 src=imagens/2.png width=102 border=0></td>
                                <td valign=top width=7 height=1>
                                    <img height=1 src=imagens/2.png width=7 border=0></td>
                                <td valign=top width=180 height=1>
                                    <img height=1 src=imagens/2.png width=180 border=0></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td valign=top width=83 height=1>
                                    <img height=1 src=imagens/2.png width=87 border=0></td>
                                <td valign=top width=7 height=1>
                                    <img height=1 src=imagens/2.png width=7 border=0></td>
                                ...
                                <td valign=top width=103 height=1>
                                    <img height=1 src=imagens/2.png width=103 border=0></td>
                                <td valign=top width=7 height=1>
                                    <img height=1 src=imagens/2.png width=7 border=0></td>
                                <td valign=top width=102 height=1>
                                    <img height=1 src=imagens/2.png width=102 border=0></td>
                    ...
                    <table cellspacing=0 cellpadding=0 width=680 border=0>
                        <tbody>
                            <tr>
                                ...
                                <td valign=top width=488 rowspan=5>
                                    <font class=ct>Instruções  (Texto de Responsabilidade do Beneficiário)
                                    </font>
                                    <br>
                                    <br>
                                    <span class=cp>
                    ...
                    <table cellspacing=0 cellpadding=0 width=680 border=0>
                        <tbody>
                            <tr>
                                <td valign=top width=680 height=1>
                                    <img height=1 src=imagens/2.png width=680 border=0></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table cellspacing=0 cellpadding=0 border=0>
                        <tbody>
                            ...
                            <tr>
                                <td class=cp valign=top width=7 height=12>
                                    <img height=12 src=imagens/1.png width=1 border=0></td>
                                <td class=cp valign=top width=679 height=12>
                    ...
                    <table cellspacing=0 cellpadding=0 border=0>
                        <tbody>
                            <tr>
                                <td class=ct valign=top width=7 height=13>
                                    <img height=13 src=imagens/1.png width=1 border=0></td>
                                <td class=cp valign=top width=486 height=13>
                                    <span class="campo">
                    ...
                    <TABLE cellSpacing=0 cellPadding=0 border=0 width=666>
                        <TBODY>
                            <TR>
                                ...
                                <TD class=ct  width=409 ><span style="margin-left:5mm;">Pagador/Avalista</span></TD>
