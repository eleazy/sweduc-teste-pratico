...
if (!function_exists('monta_linha_digitavel_inter')) {
    function monta_linha_digitavel_inter($codigo)
    {
        // campo 1
...
// 001 a 004 Código da Agência (Sem DV)
// 005 a 007 Número da Carteira do Título
// 008 a 014 Número da Operação
// 015 a 025 Nosso Número (Com DV)

$codigo_barras = $codigobanco . $nummoeda . $fator_vencimento . $valor . $agencia . $carteira . $numeroOperacao . $nossonumero;
...
$dadosboleto["linha_digitavel"] = monta_linha_digitavel_inter($linha); // verificar
