...
<HTML>
  <HEAD>
    ...
    <style type=text/css>
        ...
        -->
        :root {
            --scale-value: 1.10; /* Escala reduzida para aproveitamento de espaço */
        }
        ...
        *{margin: 0;}
        body{
            ...
            -ms-transform: scale(var(--scale-value));   /* IE9 */
            -o-transform: scale(var(--scale-value));   /* Opera 10.5+ */
            transform: scale(var(--scale-value));   /* IE8+ - must be on one line, unfortunately */
  ...
  <BODY style="height: 0px;" text=#000000 bgColor=#ffffff>

    <table cellspacing=0 cellpadding=3 style="width:500px">
      <tr style="border-bottom:1px dashed #000;"><td style="border-right:1px dashed #000;vertical-align:top;">
          ...
          <tbody>
            ...
            <tr>
              <td align="center" valign=top >
                <img src="../../clientes/<?=$cliente?>/logo.png" style="max-width: 150px;min-width: 75%;" height="40" border=0>
              </td>
            </tr>
            ...
            <tr><td valign=top style="border-bottom:1px solid #000;height:15px;">
              <span class=cp1>Data Documento</span>
              <span class=ct1><?php echo $dadosboleto["data_documento"]?></span>
            </td></tr>
            ...
            <tr><td valign=top style="border-bottom:0px solid #000;height:15px;">
              <span class=cp1>SACADO</span>
              <span class=ct1><?php echo $dadosboleto["sacado"] . "<br />" . $dadosboleto["cpf"] . "<br /> Aluno:" . $dadosboleto["nomealuno"]; ?></span>
            </td></tr>
          ...
          <thead>
            <tr>
              <td class=cp width=150>
                <span class="campo">
                  <IMG src="imagens/logosantander.jpg" width="140" height="37" border=0>
                </span></td>
...
-->
          <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
              <tr>
                <td class=ct valign=top width=7 height=13  style="border-top:1px solid #000;">
                  <img height=13 src=imagens/1.png width=1 border=0></td>
                <td class=ct valign=top width=472 height=13 style="border-top:1px solid #000;">Local de pagamento</td>
                <td class=ct valign=top width=7 height=13 style="border-top:1px solid #000;">
                  <img height=13 src=imagens/1.png width=1 border=0></td>
                <td class=ct valign=top width=180 height=13 style="border-top:1px solid #000;border-right:1px solid #000;">Vencimento</td>
              </tr>
              <tr>
                <td class=cp valign=top width=7 height=12>
                  <img height=12 src=imagens/1.png width=1 border=0></td>
                <td class=cp valign=top width=472 height=12><?php echo $dadosboleto["cedente"]; ?></td>
                <td class=cp valign=top width=7 height=12>
                  <img height=12 src=imagens/1.png width=1 border=0></td>
                <td class=cp valign=top align=right width=180 height=12 style="border-right:1px solid #000;">
                  <span class="campo">
          ...
          <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
              <tr>
                ...
                <td class=ct valign=top width=7 height=13>
                  <img height=13 src=imagens/1.png width=1 border=0></td>
                <td class=ct valign=top width=180 height=13 style="border-right:1px solid #000;">Ponto Venda / Ident.        cedente</td>
              </tr>
              <tr>
                <td class=cp valign=top width=7 height=12>
                  <img height=12 src=imagens/1.png width=1 border=0></td>
                <td class=cp valign=top width=472 height=12>
                  <span class="campo">
                    <?php echo $dadosboleto["cedente"]?> - CNPJ: <?=$dadosboleto["cpf_cnpj"]?>
                  </span></td>
                <td class=cp valign=top width=7 height=12>
                  <img height=12 src=imagens/1.png width=1 border=0></td>
                <td class=cp valign=top align=right width=180 height=12 style="border-right:1px solid #000;">
          ...
          <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
              <tr>
                ...
                <td class=ct valign=top width=7 height=13>
                  <img height=13 src=imagens/1.png width=1 border=0></td>
                <td class=ct valign=top width=180 height=13 style="border-right:1px solid #000;">Nosso        número</td>
              </tr>
              <tr>
                <td class=cp valign=top width=7 height=12>
                  <img height=12 src=imagens/1.png width=1 border=0></td>
          ...
          <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
              <tr>
                ...
                <td class=ct valign=top width=7 height=13>
                  <img height=13 src=imagens/1.png width=1 border=0></td>
                <td class=ct valign=top width=180 height=13 style="border-right:1px solid #000;">(=)        Valor documento</td>
              </tr>
              <tr>
                <td class=cp valign=top width=7 height=12>
                  <img height=12 src=imagens/1.png width=1 border=0></td>
                  ...
                  <table cellspacing=0 cellpadding=0 border=0>
                    <tbody>
                      <tr>
                        <td class=ct valign=top width=7 height=13>
                          <img height=13 src=imagens/1.png width=1 border=0></td>
                        <td class=ct valign=top width=180 height=13 style="border-right:1px solid #000;">(-)        Desconto / Abatimentos</td>
                      </tr>
                      <tr>
                        <td class=cp valign=top width=7 height=12>
                          <img height=12 src=imagens/1.png width=1 border=0></td>
                        <td class=cp valign=top align=right width=180 height=12 style="border-right:1px solid #000;"></td>
                      </tr>
                      <tr>
                        <td valign=top width=7 height=1>
                          <img height=1 src=imagens/2.png width=7 border=0></td>
                  ...
                  <table cellspacing=0 cellpadding=0 border=0>
                    <tbody>
                      <tr>
                        <td class=ct valign=top width=7 height=13>
                          <img height=13 src=imagens/1.png width=1 border=0></td>
                        <td class=ct valign=top width=180 height=13 style="border-right:1px solid #000;">(-)        Outras deduções</td>
                      </tr>
                      <tr>
                        <td class=cp valign=top width=7 height=12>
                          <img height=12 src=imagens/1.png width=1 border=0></td>
                  ...
                  <table cellspacing=0 cellpadding=0 border=0>
                    <tbody>
                      <tr>
                        <td class=ct valign=top width=7 height=13>
                          <img height=13 src=imagens/1.png width=1 border=0></td>
                        <td class=ct valign=top width=180 height=13 style="border-right:1px solid #000;">(+)        Mora / Multa</td>
                      </tr>
                      <tr>
                        <td class=cp valign=top width=7 height=12>
                          <img height=12 src=imagens/1.png width=1 border=0></td>
                  ...
                  <table cellspacing=0 cellpadding=0 border=0>
                    <tbody>
                      <tr>
                        <td class=ct valign=top width=7 height=13>
                          <img height=13 src=imagens/1.png width=1 border=0></td>
                        <td class=ct valign=top width=180 height=13 style="border-right:1px solid #000;">(+)        Outros acréscimos</td>
                      </tr>
                      <tr>
                        <td class=cp valign=top width=7 height=12>
                          <img height=12 src=imagens/1.png width=1 border=0></td>
                  ...
                  <table cellspacing=0 cellpadding=0 border=0>
                    <tbody>
                      <tr>
                        <td class=ct valign=top width=7 height=13>
                          <img height=13 src=imagens/1.png width=1 border=0></td>
                        <td class=ct valign=top width=180 height=13 style="border-right:1px solid #000;">(=)        Valor cobrado</td>
                      </tr>
                      <tr>
                        <td class=cp valign=top width=7 height=12>
                          <img height=12 src=imagens/1.png width=1 border=0></td>
          ...
          <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
              <tr>
                <td class=ct valign=top width=7 height=13>
                  <img height=13 src=imagens/1.png width=1 border=0></td>
                <td class=ct valign=top width=659 height=13 style="border-right:1px solid #000;">Sacado</td>
              </tr>
              <tr>
                <td class=cp valign=top width=7 height=12>
                  <img height=12 src=imagens/1.png width=1 border=0></td>
                <td class=cp valign=top width=659 height=12 style="border-right:1px solid #000;">
                  <span class="campo" style="float:left;"><?php echo $dadosboleto["sacado"]?></span>
          ...
          <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
              <tr>
                ...
                <td class=ct valign=top width=7 height=13>
                  <img height=13 src=imagens/1.png width=1 border=0></td>
                <td class=ct valign=top width=180 height=13 style="border-right:1px solid #000;">Cód.        baixa</td>
              </tr>
              <tr>
                <td valign=top width=7 height=1>
                  <img height=1 src=imagens/2.png width=7 border=0></td>
