...
if (!function_exists('monta_linha_digitavel_carne_deitado')) {
    function monta_linha_digitavel_carne_deitado($codigo)
    {
        // Posi��o  Conte�do
...
$dadosboleto["linha_digitavel"] = monta_linha_digitavel_carne_deitado($linha);
