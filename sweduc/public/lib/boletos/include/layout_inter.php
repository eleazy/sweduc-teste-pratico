      ...
      -->
        ...
        *{margin: 0;}
        body{
            top:0px;
            left:0px;
            margin: 30px 0px 0px 70px; /* margem reduzida para aproveitamento de espaço */
        ...
        <table cellspacing=0 cellpadding=0 border=0 style="width:150px">
          <tbody>
            ...
            <tr><td valign=top style="border-bottom:1px solid #000;">
              <IMG src="imagens/logointer.svg" width="150" height="90" border=0 style="float:center;">
            </td></tr>
    ...
    <table cellspacing=0 cellpadding=0 width=666 border=0>
      <tr>
        <td class=cp width=100 >
          <span class="campo">
            <IMG src="imagens/logointer.svg" width="100" height="60" style="position:absolute; top: -19;" border=0>
          </span></td>
    ...
    <table cellspacing=0 cellpadding=0 border=0>
      <tbody>
        ...
        <tr>
          ...
          <td class=cp valign=top width=472 height=12>Pagável em qualquer banco.</td>
          <td class=cp valign=top width=7 height=12>
            <img height=12 src=imagens/1.png width=1 border=0></td>
