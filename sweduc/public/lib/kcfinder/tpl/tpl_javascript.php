...
browser.support.chromeFrame = <?php echo (str_contains(strtolower($_SERVER['HTTP_USER_AGENT']), " chromeframe")) ? "true" : "false" ?>;
...
browser.access = <?php echo json_encode($this->config['access'], JSON_THROW_ON_ERROR) ?>;
