...
class PHPMailer
{
     ...
     * @static
     */
    public static function mb_pathinfo($path, int|string $options = null): string|array
    {
    ...
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        foreach ($headers as $header) {
            if (str_starts_with($header, 'From:')) {
                ...
                if ($current && str_starts_with($header, ' =?')) {
                    $current .= $header;
                } else {
                    $current = '';
                }
