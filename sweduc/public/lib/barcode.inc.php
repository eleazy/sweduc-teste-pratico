...
{
    private array $digitArray = [0 => "00110", 1 => "10001", 2 => "01001", 3 => "11000", 4 => "00101", 5 => "10100", 6 => "01100", 7 => "00011", 8 => "10010", 9 => "01010"];
    function __construct($value, private $into = 1, private $file = 'barcode.gif', $width_bar = 300, $height_bar = 65, $show_codebar = false)
    {
        ...
        if ($show_codebar) {
            imagestring($img, 3, 3, $height_bar + 1, " " . $value, imagecolorallocate($img, 0, 0, 0));
        }
